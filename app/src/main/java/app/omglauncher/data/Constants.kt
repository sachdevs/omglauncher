...
//    const val THEME_MODE_SYSTEM = 2
    ...
    const val LONG_PRESS_TIMER_DEFAULT_DURATION_MS = 10L * ONE_MINUTE_IN_MILLIS
    const val BEEMINDER_TIMER_TICK_MS = 250L
    const val BEEMINDER_TIMER_ALERT_MS = 3000L
    const val BEEMINDER_REFRESH_INTERVAL_MS = 15L * ONE_MINUTE_IN_MILLIS

    const val MIN_ANIM_REFRESH_RATE = 30f

    const val URL_ABOUT_OMGLAUNCHER = "https://tanujnotes.substack.com/p/omglauncher-minimal-af-launcher?utm_source=omglauncher"
    const val URL_OMGLAUNCHER_PRIVACY = "https://tanujnotes.notion.site/Omglauncher-Privacy-Policy-dd6ac5101ddd4b3da9d27057889d44ab"
    const val URL_DOUBLE_TAP = "https://tanujnotes.notion.site/Double-tap-to-lock-Omglauncher-0f7fb103ec1f47d7a90cdfdcd7fb86ef"
    const val URL_OMGLAUNCHER_GITHUB = "https://www.github.com/tanujnotes/Omglauncher"
    const val URL_OMGLAUNCHER_PLAY_STORE = "https://play.google.com/store/apps/details?id=app.omglauncher"
    const val URL_OMGLAUNCHER_PRO = "https://play.google.com/store/apps/details?id=app.prolauncher"
    ...
    const val URL_DIGITAL_WELLBEING_LEARN_MORE = "https://tanujnotes.substack.com/p/digital-wellbeing-app-on-android?utm_source=omglauncher"
