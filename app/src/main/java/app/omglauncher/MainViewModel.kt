...
import app.omglauncher.helper.getPrivateSpaceApps
import app.omglauncher.helper.getPrivateSpaceUserHandle
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val isOmglauncherDefault = MutableLiveData<Boolean>()
    ...
    fun isOmglauncherDefault() {
        isOmglauncherDefault.value = isOmglauncherDefault(appContext)
    }
